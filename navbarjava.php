...
<li><button class="btn home"><div class="w3-padding w3-xlarge ">
    ...
    <h4><b>BASCIS JAVA</b></h4>
    <h5>15-Sep-2017 00:00 to 21-Sep-2017 23:59</h5>
     <a href="conditionjava.php?q=1">   <button class="take test">Take Test</button></a>
   
    </div>
    <div id="box1">

    <h4><b>CLASSES AND INTERFACE</b></h4>
    <h5>15-Sep-2017 00:00 to 21-Sep-2017 23:59</h5>
<a href="conditionjava.php?q=2">   <button class="take test">Take Test</button></a>
